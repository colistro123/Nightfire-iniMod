...
#define PERFORMSTEP	(*g_engfuncs.pfnPerformStep)
#define DECALINDEX2 (*g_engfuncs.pfnDecalIndex2)
#define GETBONETRANSFORM1 (*g_engfuncs.pfnGetBoneTransform1)
#define LOADFILEFORME2 (*g_engfuncs.pfnLoadFileForMe2)
#define COM_FILEBASE (*g_engfuncs.pfnCOM_FileBase)
...
#define CVAR_GET_FLOAT_OLD	(*g_engfuncs.pfnCVarGetFloat_Old)
#define CVAR_GET_FLOAT	(*g_engfuncs.pfnCVarGetFloat)
#define CVAR_GET_INT	(*g_engfuncs.pfnCVarGetInt)
#define CVAR_GET_BOOL	(*g_engfuncs.pfnCVarGetBool)
#define CVAR_GET_STRING_OLD	(*g_engfuncs.pfnCVarGetString)
#define CVAR_GET_STRING	(*g_engfuncs.pfnCVarGetString_Old)
#define CVAR_SET_FLOAT_OLD	(*g_engfuncs.pfnCVarSetFloat_Old)
#define CVAR_SET_FLOAT	(*g_engfuncs.pfnCVarSetFloat)
#define CVAR_SET_INT	(*g_engfuncs.pfnCVarSetInt)
#define CVAR_SET_BOOL	(*g_engfuncs.pfnCVarSetBool)
#define CVAR_SET_STRING_OLD	(*g_engfuncs.pfnCVarSetString_Old)
